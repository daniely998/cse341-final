...
router.post('/', validator.userValidationRules(), validator.validate, controllers.createUser);

router.put('/:id', validator.userValidationRules(), validator.validate, controllers.updateUser);
